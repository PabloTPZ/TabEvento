...
import com.example.hola.eventotab.clases.EventoAdapter3;
 ...
 */
public class EventoFragmentFeria extends Fragment {
...
//    DatabaseReference myDataBase = FirebaseDatabase.getInstance().getReference();
  //  DatabaseReference conferencias = myDataBase.child("Conferencias");
    ...
    public void usarRecycleView() {
        ...
        adapter = new EventoAdapter3(listaEventos);
    ...
    public void onStart() {
        listaEventos.clear();
        super.onStart();
        listaEventos.add(new Evento("3", "titulo 3", "hora 3", "expositor evento 3", "img"));
        listaEventos.add(new Evento("3", "titulo 3", "hora 3", "expositor evento 3", "img"));
        listaEventos.add(new Evento("3", "titulo 3", "hora 3", "expositor evento 3", "img"));
        listaEventos.add(new Evento("3", "titulo 3", "hora 3", "expositor evento 3", "img"));
        listaEventos.add(new Evento("3", "titulo 3", "hora 3", "expositor evento 3", "img"));
